        ...
        <tr>
          <td height="343" align="left" valign="top">
		   <form action="" method="post" name="testform" onSubmit="return checkForm(this)">
		     <strong><a href="addpharmacy.php" style="text-decoration:none">ADD</a></strong>
...
?>				  
                      <tr>
                       ...
                       <td align="center"><?php echo $res->Mobi; ?></td>
                        ...
                        <td align="center">
<a href="pharmacy.php?id=<?php echo $res->EmpId ?>&amp;Mode=Edit">
<img src="images/editform.png" width="25" height="25" /></a> 
<img src="images/space.png" /> 
<a href="pharmacy.php?id=<?php echo $res->EmpId ?>&Mode=Delete" onClick="return confirm(' Are You Sure To Delete? ');" > 
