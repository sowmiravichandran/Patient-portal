...
<div align="center">
  ...
  <td><table border="1" cellpadding="6" style="border-collapse: collapse" width="100%">
      ...
      <td height="337" valign="top"><form action="" method="post" onSubmit="return checkForm(this)">
           <table width="745" align="center" cellpadding="4" cellspacing="4" background="images/graphics (41).jpg">
		   <h2>Change Password</h2>
            <tr>
              <td width="77">&nbsp;</td>
              <td width="121"><font face="Times New Roman, Times, serif" size="+1" color="#990000">User Name </font></td>
              <td width="238"><input name="userid" type="text" size="35" value="<?php echo $_SESSION["name"];?>" class="search_input" readonly/></td>
              <td width="169" rowspan="4"><img src="images/reset.png" width="151" height="175"></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td><font face="Times New Roman, Times, serif" size="+1" color="#990000">Old Password </font></td>
              <td><input name="oldpwd" type="text" size="35" value="<?php echo $_SESSION["pwd"];?>" readonly class="search_input" /></td>
              </tr>
            <tr>
              <td>&nbsp;</td>
...
<input type="reset" name="clear" value="CLEAR" class="greenButton" /></td>
		...
		if(isset($_POST["submit"]))
		{
		 ...
		 $pwd=$_POST["oldpwd"];
		 $new=$_POST["newpwd"];
		 $q="update pharmacy set Pwd='$new' where EId='$id'";
		  $res=mysql_query($q);
			 if(!$res)
			{
			?>
