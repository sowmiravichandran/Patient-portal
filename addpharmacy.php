		   ...
		   <form action="" method="post" name="testform" onSubmit="return checkForm(this)">
					...
					<tr><td colspan="4" align="center"><h2>
                      ...
                      Pharmacy Employee Entry</h2></td>
                        ...
                        <td width="172" >
						<input type="text" name="empname" size="30" class="search_input" onKeyPress="return onKeyPressBlockNumbers(event);" value=""/></td>
					  ...
					  <td><label><font face="Times New Roman, Times, serif" size="+1" color="#990000">Password</font></label></td>
                        <td><input type="password" name="password" size="30" class="search_input" /></td><td align="center">&nbsp;</td>
                      </tr>
                      <tr>
					  <td colspan="4" align="center"><input type="submit" name="submit" value="ADD" class="greenButton"/>&nbsp;&nbsp;&nbsp;                          
...
$q="insert into pharmacy(EmpName,Gend,DOB,Mobi,Addr,Sala,EId,Pwd,Dt)values('$name','$gender','$dob','$mobile','$ad','$salary','$userid','$pwd',CURDATE())";
			...
			?> 		   </td>
				...
				<tr align="center">
		  <td><strong>Pateint Portal System</strong> </td>
		</tr>
      </table></td>
  </tr>
  </table>
