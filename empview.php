        ...
        <tr>
          <td height="343" align="left" valign="top">
		   <form action="" method="post" name="testform" onSubmit="return checkForm(this)">
		     <strong><a href="addempdetails.php" style="text-decoration:none">Add Employees</a></strong>
		     <table align="center" width="100%" background="images/graphics (41).jpg" height="40" >
				<tr >
				
				<td height="34" colspan="9" align="center">	<h2>Employee List </h2></td></tr>
					   ...
					   <tr style="background-color:#999999;color:#FFFFFF">
                        ...
                        <td width="12%" align="center"><strong>POS.</strong></td>
                        <td width="9%" align="center"><strong>MOBILE</strong></td>
...
$sqlup="Select * from {$statement}
        where {$where} ORDER BY EmpId LIMIT {$startpoint},{$limit}";
...
?>				  
                      <tr>
                        <td align="center"><?php echo $res->EmpId; ?></td>
                        <td align="center"><?php echo $res->EmpName; ?></td>
                        <td align="center"><?php echo $res->DOB; ?></td>
                        <td align="center"><?php echo $res->Quali; ?></td>
                        <td align="center"><?php echo $res->Mobi; ?></td>
                        <td align="center"><?php echo $res->Addr; ?></td>
                        <td align="center"><?php echo $res->EId; ?></td>
                        <td align="center">
<a href="empdetails.php?id=<?php echo $res->EmpId ?>&amp;Mode=Edit">
<img src="images/editform.png" width="25" height="25" /></a> 
<img src="images/space.png" /> 
<a href="empdetails.php?id=<?php echo $res->EmpId ?>&Mode=Delete" onClick="return confirm(' Are You Sure To Delete? ');" > 
