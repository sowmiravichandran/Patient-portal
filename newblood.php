    ...
    <td><table border="1" cellpadding="6" style="border-collapse: collapse" width="100%">
        <tr>
		   ...
		   <form action="" method="post" name="testform" onSubmit="return checkForm(this)">
					...
					<th colspan="2"><h3>Blood Donor Registration</h3>					  </th>
					<tr>
                      ...
                      <tr>
                        <td><label><font face="Times New Roman, Times, serif" size="+1" color="#990000">Donate Unit</font></label></td>
                        <td><input type="text" name="unit" size="30" onKeyPress="return num(event)" class="search_input"/></td>
                      </tr>
                      <tr>
                        <td><label><font face="Times New Roman, Times, serif" size="+1" color="#990000">Last Donation</font></label></td>
                        <td><input type="text" name="lastdonation" size="30" class="search_input" /></td>
                      </tr>
                      <tr>
			...
			if(isset($_POST["submit"]))
			{
			 ...
			 $blood=$_POST["blood"];
			 $unit=$_POST["unit"];
			 $last=$_POST["lastdonation"];
			 $mobile=$_POST["mobileno"];
			 $mail=$_POST["mailid"];
			 $address=$_POST["address"];
			 //$date=getDate();
			 $q="insert into blooddonation(name,sex,age,sbg,unit,ldon,mobile,email,address,Dt)values('$name','$gender','$age','$blood','$unit','$last','$mobile','$mail','$address',CURDATE())";
			 $res=mysql_query($q);
			 if(!$res)
			 {
			 ?>
